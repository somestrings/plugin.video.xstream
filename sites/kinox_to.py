...
SITE_NAME = 'KinoX'
SITE_ICON = 'kinox.png'
SITE_SETTINGS = '<setting default="www12.kinos.to" enable="!eq(-2,false)" id="kinox_to-domain" label="30051" type="labelenum" values="www12.kinos.to|kinox.ai|kinox.am|kinox.bz|kinox.click|kinox.cloud|kinox.club|kinox.digital|kinox.direct|kinox.express|kinox.fun|kinox.fyi|kinox.gratis|kinox.io|kinox.lol|kinox.me|kinox.mobi|kinox.nu|kinox.party|kinox.pub|kinox.sg|kinox.sh|kinox.space|kinox.sx|kinox.to|kinox.tube|kinox.tv|kinox.wtf|kinoz.to" />'
